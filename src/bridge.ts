...
let demoHistory: TranscriptRecord[] = [
  {
    ...
    magicText: "Move the design review to Thursday and include the new onboarding notes.",
...
const mockApi: DeluluApi = {
  ...
  onSettingsChanged(_callback: (settings: AppSettings) => void) { return () => undefined; },
  onNavigate(_callback: (page: Page) => void) { return () => undefined; },
