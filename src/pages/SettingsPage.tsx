  ...
  return (
    <div className="content-stack settings-page">
      ...
      <section className="settings-group paper-card"><div className="group-heading"><p className="eyebrow">CAPTURE</p><h3>Listening & shortcuts</h3></div>
        ...
        <SettingRow icon={Mic2} title="Recording behavior" description="Press once to start after the sound, speak freely, then press once more to stop. Hold remains available for quick notes."><div className="segmented"><button className={draft.recordingMode === "toggle" ? "active" : ""} onClick={() => setDraft({ ...draft, recordingMode: "toggle" })}>Press once</button><button className={draft.recordingMode === "hold" ? "active" : ""} onClick={() => setDraft({ ...draft, recordingMode: "hold" })}>Hold</button></div></SettingRow>
