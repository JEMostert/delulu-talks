...
export const MODELS: ModelInfo[] = [
  {
    ...
    description:
      "Near-large quality with a friendlier memory footprint. The default for fast, precise local dictation.",
    size: "Medium",
    memory: "Balanced",
    latency: "Fast",
    accent: "coral",
  ...
  },
  {
    ...
    description:
      "A four-decoder-layer model for the lowest dictation latency, with a modest quality tradeoff.",
    size: "Turbo",
    memory: "Medium",
    latency: "Fastest",
    accent: "blue",
  ...
  },
  {
    ...
    description:
      "Nyra's highest-quality standard checkpoint. Pair it with Turbo for output-preserving speculative decoding.",
    size: "Large",
    memory: "High",
  ...
  },
  {
    ...
    description:
      "The smallest official 2.0 checkpoint for CPU-first systems or machines with limited memory.",
    size: "Small",
    memory: "Lowest",
    latency: "Lightweight",
    accent: "yellow",
