...
const STEPS = [
  ...
  },
  {
    ...
    body: "Hold Ctrl + Shift + Space while speaking. Release to transcribe. If Magic is enabled, the local Qwen model rewrites the result before it is copied and pasted back into the app you were using.",
  },
  {
    icon: WandSparkles,
  ...
  return <div className="onboarding-backdrop">
    <section className="onboarding" role="dialog" aria-modal="true" aria-labelledby="onboarding-title">
      ...
      <div className="onboarding-content">
        ...
        <p>{current.body}</p>
        {step === 1 && <div className="onboarding-flow"><kbd>Ctrl + Shift + Space</kbd><ArrowRight /><span>Speech</span><ArrowRight /><span>Magic</span><ArrowRight /><span>Paste</span></div>}
